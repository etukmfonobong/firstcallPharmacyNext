				...
				<footer className="py-10 px-14 text-white font-poppins lg:px-36 md:px-20 lg:py-20 md:py-14 bg-dull-blue">
						...
						<div className="grid grid-cols-1 gap-7 lg:grid-cols-4 md:grid-cols-2">
								...
								<div className={"grid grid-rows-with-header gap-7 pb-14"}>
										<h2>
												<span className={"text-2xl font-bold"}>Firstcall</span> <span className={"text-xl"}>Pharmacy</span>
										</h2>
										<p className={"text-sm leading-normal break-words"}>
												Powerfully flexible WordPress theme for medical & health related organizations, institutes, clinics and businesses.
										</p>
								</div>

								{/*useful links start*/}
								<div className={"grid grid-rows-with-header gap-5 pb-14"}>
										<h2 className={"text-base font-semibold uppercase"}>useful links</h2>
								...
								{/*follow us start*/}
								<div className={"grid grid-rows-with-header gap-7 pb-14"}>
										<h2 className={"text-base font-semibold uppercase"}>follow us</h2>

										{/*social links grid start*/}
